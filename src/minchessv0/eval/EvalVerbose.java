...
public class EvalVerbose implements Evaluator {

    public EvalVerbose() {
        this(Board.startingPosition());
    }

    public EvalVerbose(long[] board) {
        this.board = board;
    ...
    @Override
    public int eval() {
        int kingEval = kingEval(Value.WHITE, Value.BLACK, board[Piece.WHITE_ROOK], board[Piece.WHITE_PAWN], board[Piece.BLACK_PAWN]);
        int queenEval = queenEval(Value.WHITE, Value.BLACK, board[Piece.WHITE_QUEEN], board[Piece.WHITE_BISHOP], board[Piece.WHITE_KNIGHT]);
        int rookEval = rookEval(Value.WHITE, Value.BLACK, board[Piece.WHITE_ROOK], board[Piece.WHITE_KING], board[Piece.WHITE_PAWN], board[Piece.BLACK_PAWN], board[Piece.BLACK_QUEEN]);
        int bishopEval = bishopEval(Value.WHITE, Value.BLACK, board[Piece.WHITE_BISHOP], board[Piece.WHITE_PAWN], board[Piece.BLACK_PAWN]);
        int knightEval = knightEval(Value.WHITE, Value.BLACK, board[Piece.WHITE_KNIGHT], board[Piece.WHITE_PAWN], board[Piece.BLACK_PAWN]);
        int pawnEval = pawnEval(Value.WHITE, Value.BLACK, board[Piece.WHITE_PAWN], board[Piece.BLACK_PAWN], board[Piece.WHITE_KING]);
        int whiteEval = kingEval + queenEval + rookEval + bishopEval + knightEval + pawnEval;
        System.out.println("whiteEval " + whiteEval);
        System.out.println("kingEval " + kingEval);
        System.out.println("queenEval " + queenEval);
        System.out.println("rookEval " + rookEval);
        System.out.println("bishopEval " + bishopEval);
        System.out.println("knightEval " + knightEval);
        System.out.println("pawnEval " + pawnEval);
        kingEval = kingEval(Value.BLACK, Value.WHITE, board[Piece.BLACK_ROOK], board[Piece.BLACK_PAWN], board[Piece.WHITE_PAWN]);
        queenEval = queenEval(Value.BLACK, Value.WHITE, board[Piece.BLACK_QUEEN], board[Piece.BLACK_BISHOP], board[Piece.BLACK_KNIGHT]);
        rookEval = rookEval(Value.BLACK, Value.WHITE, board[Piece.BLACK_ROOK], board[Piece.BLACK_KING], board[Piece.BLACK_PAWN], board[Piece.WHITE_PAWN], board[Piece.WHITE_QUEEN]);
        bishopEval = bishopEval(Value.BLACK, Value.WHITE, board[Piece.BLACK_BISHOP], board[Piece.BLACK_PAWN], board[Piece.WHITE_PAWN]);
        knightEval = knightEval(Value.BLACK, Value.WHITE, board[Piece.BLACK_KNIGHT], board[Piece.BLACK_PAWN], board[Piece.WHITE_PAWN]);
        pawnEval = pawnEval(Value.BLACK, Value.WHITE, board[Piece.BLACK_PAWN], board[Piece.WHITE_PAWN], board[Piece.BLACK_KING]);
        int blackEval = kingEval + queenEval + rookEval + bishopEval + knightEval + pawnEval;
        System.out.println("blackEval " + blackEval);
        System.out.println("kingEval " + kingEval);
        System.out.println("queenEval " + queenEval);
        System.out.println("rookEval " + rookEval);
        System.out.println("bishopEval " + bishopEval);
