...
public class Fen {
    ...
    public static boolean getWhiteToMove(String fen) {
        char fenPlayerChar = fen.charAt(getSpaceIndex(fen, 1) + 1);
        return fenPlayerChar == 'w';
    }
    ...
    public static int getHalfMoveClock(String fen) {
        int clockIndex = getSpaceIndex(fen, 4) + 1;
        return clockIndex == -1 ? -1 : Integer.parseInt(fen.substring(clockIndex, getSpaceIndex(fen, 5)));
    }

    public static int getFullMoveNumber(String fen) {
        int clockIndex = getSpaceIndex(fen, 5) + 1;
        return Integer.parseInt(fen.substring(clockIndex));
    }
